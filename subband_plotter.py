...
parser.add_argument('-d',   dest='dir',   type=str,   help='directory of data to plot. Default is the scripts directory.',default='.')
parser.add_argument('-n',   dest='nsub',  type=int,   help='number of subbands to plot. Deflaut = 1',default=1)
parser.add_argument('-f',   dest='file',  type=str,   help='naming convetion of the file(s) with {0} where the number iteration is')
